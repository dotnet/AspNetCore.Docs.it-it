...
## <a name="changes-to-blazor-app-routing-logic-in-501-and-further-5x-releases-up-to-60"></a>Modifiche alla Blazor logica di routing delle app in 5.0.1 e altre 5. x versioni fino a 6,0
...
## <a name="update-blazor-webassembly-and-blazor-server-projects"></a>Aggiornamento Blazor WebAssembly e Blazor Server progetti
...
## <a name="update-blazor-webassembly-projects"></a>Aggiornare i Blazor WebAssembly progetti
...
1. In `Program.Main` ( `Program.cs` ) modificare il riferimento all'elemento in `<app>` un selettore CSS aggiungendovi un hash `#` :
...
1. In `Program.Main` ( `Program.cs` ), impostare una registrazione temporanea predefinita `HttpClient` su con ambito, se presente:
...
1. In `Program.Main` ( `Program.cs` ) dell' **`Client`** app di soluzioni ospitate Blazor :
    
   * Facoltativamente, sostituire `builder.HostEnvironment.BaseAddress` per gli indirizzi di base del client di stringa.
   * Modificare le registrazioni di Factory client temporanee denominate in ambito.
...
### <a name="standalone-blazor-webassembly-app-with-microsoft-accounts"></a>App autonoma Blazor WebAssembly con account Microsoft
...
### <a name="standalone-blazor-webassembly-app-with-azure-active-directory-aad"></a>App autonoma Blazor WebAssembly con Azure Active Directory (AAD)
...
### <a name="standalone-blazor-webassembly-app-with-azure-active-directory-aad-b2c"></a>App autonoma Blazor WebAssembly con Azure Active Directory (AAD) B2C
...
### <a name="hosted-blazor-webassembly-app-with-azure-active-directory-aad-or-aad-b2c"></a>App ospitata Blazor WebAssembly con Azure Active Directory (AAD) o AAD B2C
...
### <a name="update-the-server-project-of-a-hosted-blazor-solution"></a>Aggiornare il progetto server di una soluzione ospitata Blazor
...
## <a name="update-a-blazor-progressive-web-application-pwa"></a>Aggiornare un' Blazor applicazione Web progressiva (PWA)
...
## <a name="update-razor-class-libraries-rcls"></a>Aggiornare le Razor librerie di classi (RCL)
...
## <a name="model-binding-changes-in-aspnet-core-mvc-and-razor-pages"></a>Modifiche dell'associazione di modelli in ASP.NET Core MVC e Razor pagine
